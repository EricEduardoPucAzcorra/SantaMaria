...
class graficaDRController extends Controller
{
    private $array=[];

    public function getDetalles_R(){

        $etiquetas=DB::select("SELECT DISTINCT(created_at),id_detalle_reserva  FROM detalle_reservaciones");
        ...
        $serie1 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='01'");
        //array capturador
        $sers1 = [];
        ...
        $serie2 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='02'");
        //array capturador
        $sers2 = [];
        //convertimos enun array plano
        ...
        $serie3 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='03'");
        //array capturador
        $sers3 = [];
        //convertimos enun array plano
        ...
        $serie4 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='04'");
        //array capturador
        $sers4 = [];
        //convertimos enun array plano
        ...
        $serie5 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='05'");
        //array capturador
        $sers5 = [];
        //convertimos enun array plano
        ...
        $serie6 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='06'");
        //array capturador
        $sers6 = [];
        //convertimos enun array plano
        ...
        $serie7 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='07'");
        //array capturador
        $sers7 = [];
        //convertimos enun array plano
        ...
        $serie8 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='08'");
        //array capturador
        $sers8 = [];
        //convertimos enun array plano
        ...
        $serie9 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='09'");
        //array capturador
        $sers9 = [];
        //convertimos enun array plano
        ...
        $serie10 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='10'");
        //array capturador
        $sers10 = [];
        //convertimos enun array plano
        ...
        $serie11 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='11'");
        //array capturador
        $sers11 = [];
        //convertimos enun array plano
        ...
        $serie12 = DB::select("SELECT total FROM detalle_reservaciones WHERE $mes='12'");
        //array capturador
        $sers12 = [];
        //convertimos enun array plano
