        ...
        <div class="m-5">
            <table class="table table-hover">
                ...
                <tbody class="contenido-tabla">
                    <tr v-for="categoria in cat_platillos" :key="categoria.id_categoriaP">
                        ...
                        <td>
                            ...
                            <template v-if="categoria.estado">    
                                <button type="button"  @click="desactivar(categoria.id_categoriaP)" class="btn btn-outline-light">
                                    <i class="fas fa-arrow-down"></i> Desactivar
                                </button>
                            </template>
                            <template v-else>     
                                <button type="button" @click="activar(categoria.id_categoriaP)" class="btn btn-outline-warning">
    ...
    export default {
        ...
        methods: {
            ...
            registrarCategoria(){
                ...
                let cargar = this;
                let url = '/categoria_platillos/registrar';
            ...
            actualizarCategoria(){
                ...
                let cargar = this;
                let url = '/categoria_platillos/actualizar';
            ...
            activar(id){
                 let cargar = this;
                 let url = '/categoria_platillos/activar';
           ...
           desactivar(id){
                 let cargar = this;
                 let url = '/categoria_platillos/desactivar';
